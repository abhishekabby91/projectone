...
export const industries = [
  { id: 'cpa-firms', slug: 'cpa-firms', name: 'CPA Firms', icon: '📊', description: 'Support for CPA and accounting firms when recurring bookkeeping, cleanup, tax-season preparation, or audit work starts competing with review and client-facing time.', features: ['Bookkeeping and cleanup', 'Tax-season preparation', 'Audit support'] },
  { id: 'technology', slug: 'technology', name: 'Technology & SaaS', icon: '💻', description: 'Bookkeeping for SaaS, software and technology businesses — deferred revenue maintained against the contract term, settlements decomposed, and a close that reconciles.', features: ['Deferred revenue and subscriptions', 'Settlement decomposition', 'Month-end close and reporting'] },
  { id: 'healthcare', slug: 'healthcare', name: 'Healthcare', icon: '🏥', description: 'Accounting and back-office support for medical practices and healthcare providers, with attention to reconciliations, payables, receivables, payroll, and recurring reporting.', features: ['Payer receipt reconciliation', 'AP/AR and payroll support', 'Recurring reporting'] },
  { id: 'ecommerce', slug: 'ecommerce', name: 'E-Commerce', icon: '🛒', description: 'Accounting support for online retailers and marketplace businesses dealing with sales channels, payment processors, refunds, fees, inventory-related activity, payables, and reconciliations.', features: ['Settlement decomposition', 'COGS and inventory records', 'Channel-level reporting'] },
  { id: 'real-estate', slug: 'real-estate', name: 'Real Estate', icon: '🏠', description: 'Accounting, bookkeeping and tax support for property owners, investors, developers and commercial operators — portfolio and entity books, and the statements a lender or partner reads.', features: ['Property and entity-level books', 'Investor and lender reporting', 'Acquisition and disposal records'] },
  // Split out of Real Estate on 2026-09-17 (owner). These are the two highest
  // demand terms in the cluster and neither could rank from inside a page
  // titled for real estate. The three are kept apart by reader, not keyword:
  // owner / manager / association. See the header notes in each lib module.
  { id: 'property-management', slug: 'property-management', name: 'Property Management', icon: '🏢', description: 'Accounting and bookkeeping for property management companies — property-level books, owner statements, tenant and deposit ledgers, CAM recovery and month-end close.', features: ['Owner statement preparation', 'Tenant and deposit ledgers', 'CAM and recovery support'] },
  { id: 'hoa-accounting', slug: 'hoa-accounting', name: 'HOA & Associations', icon: '🏘️', description: 'Accounting for HOAs, condominium associations and community management companies — assessment ledgers, operating and reserve funds, delinquency schedules and board packs.', features: ['Assessment and homeowner ledgers', 'Operating and reserve funds', 'Monthly board packs'] },
  { id: 'professional-services', slug: 'professional-services', name: 'Professional Services', icon: '⚖️', description: 'Bookkeeping for law firms, consulting firms and agencies — client trust ledgers and three-way reconciliation, work in progress, retainers and partner accounts.', features: ['Law firm trust ledgers', 'WIP and unbilled time', 'Retainers and partner accounts'] },
];
