...
export const industries = [
  ...
  { id: 'technology', slug: 'technology', name: 'Technology', icon: '💻', description: 'Accounting operations support for SaaS, software, and technology businesses where transaction volume, subscriptions, integrations, and reporting can make the close harder to keep consistent.', features: ['Subscription revenue records', 'Month-end close', 'Financial reporting'] },
  ...
  { id: 'real-estate', slug: 'real-estate', name: 'Real Estate', icon: '🏠', description: 'Accounting, bookkeeping and tax support for real estate businesses, property management companies, HOAs and community associations, commercial operators, investors and developers.', features: ['Property-level bookkeeping', 'Owner statements and board packs', 'HOA assessments and reserves'] },
  { id: 'professional-services', slug: 'professional-services', name: 'Professional Services', icon: '⚖️', description: 'Accounting and back-office support for consulting, legal, agency, and other professional service businesses where billing, payroll, expenses, and month-end reporting need to stay organized.', features: ['Client billing records', 'Expenses and payroll support', 'Month-end close'] },
];
